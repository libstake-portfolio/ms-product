...
import { ArchiveOptionCommand } from '../archive-option.command';

@CommandHandler(ArchiveOptionCommand)
export class ArchiveOptionHandler implements TypedCommandHandler<ArchiveOptionCommand> {
    public constructor(
    ...
    public async execute(command: ArchiveOptionCommand): Promise<void> {
